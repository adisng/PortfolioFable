      ...
      <div className="grid gap-4 sm:grid-cols-2 md:grid-cols-3">
        ...
        <Reveal className="md:row-span-2">
          <article className="glass flex h-full flex-col p-6">
            ...
            <div className="relative mt-6 aspect-[3/4] overflow-hidden border-2 border-border">
              <Image
        ...
        <Reveal delay={0.15}>
          <article className="glass grid h-full grid-cols-2 gap-px bg-border p-0">
            {stats.map((stat) => (
              <div
                key={stat.label}
                className="flex flex-col justify-center bg-card p-4 sm:p-6"
              >
                <p className="text-2xl sm:text-4xl font-black text-foreground">
                  {stat.value}
                </p>
                <p className="mt-1 font-mono text-[10px] sm:text-xs uppercase tracking-widest text-muted-foreground">
                  {stat.label}
                </p>
              </div>
            ))}
